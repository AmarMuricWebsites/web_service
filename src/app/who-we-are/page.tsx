...
import { Users, Globe, Award, Sparkles, Lightbulb, Target } from "lucide-react";
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">
                The IT System Solutions Story
              </h2>
              <div className="space-y-4 text-gray-500 dark:text-gray-400">
                <p>
                  IT System Solutions was founded with a simple mission: to
                ...
                <p>
                  ...
                  Swedish management and communication, we've created a unique
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group">
              ...
              <div className="mt-4 text-center">
                <h3 className="text-xl font-bold">Erik Johansson</h3>
            ...
            <div className="group">
              ...
              <div className="mt-4 text-center">
                <h3 className="text-xl font-bold">Anna Lindberg</h3>
                <p className="text-gray-500 dark:text-gray-400">
                  Project Manager
                </p>
              </div>
            ...
            <div className="group">
              ...
              <div className="mt-4 text-center">
                <h3 className="text-xl font-bold">Milan Petrović</h3>
                <p className="text-gray-500 dark:text-gray-400">
                  Lead Developer
                </p>
              </div>
            ...
            <div className="group">
              ...
              <div className="mt-4 text-center">
                <h3 className="text-xl font-bold">Jelena Nikolić</h3>
                <p className="text-gray-500 dark:text-gray-400">
                  UI/UX Designer
                </p>
              </div>
